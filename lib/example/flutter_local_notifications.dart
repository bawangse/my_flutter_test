...
import 'dart:convert';
import 'dart:io';
// Flutter 插件提供有关设备（制造商、型号等）的详细信息，以及运行该应用程序的 Android 或 iOS 版本。
...
///创建流，以便应用程序能够响应与通知相关的事件
/// since the plugin is initialised in the `main` function
/// 因为插件是在“main”函数中初始化的
/// since 美 [sɪns] （sen-四）conj. 因为
/// receive 英 /rɪˈsiːv/ v.接收;拿到;体验;
/// broadcast 美/ˈbrɔːdkæst/ v.广播
...
class ReceivedNotification {
  ...
  final String? title;
  final String? body;
  // payload 美/ˈpeɪloʊd/ n.(飞机、船只的)有效载荷，有酬负载;(车辆等的)装载货物，装载量;(炸弹、导弹的)爆炸力，炸药量;
...
void notificationTapBackground(NotificationResponse notificationResponse) {
  // ignore: avoid_print
  log.i('notification(${notificationResponse.id}) action tapped: '
